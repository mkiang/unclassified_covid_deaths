...
p1 <- ggplot2::ggplot(
    ...
    ggplot2::facet_wrap( ~ metric_cat, scales = "free_x") +
...
## Save ----
ggplot2::ggsave(
    here::here("plots", "figS5_model_performance_secondary.pdf"),
    p1,
    width = 10,
    height = 12,
...
ggplot2::ggsave(
    here::here("plots", "figS5_model_performance_secondary.jpg"),
    p1,
    width = 10,
    height = 12,
    dpi = 1200
...
write_csv(
    ...
    here(
        "output",
        "figure_data",
        "figS5_data_model_performance_secondary.csv"
    )
)
