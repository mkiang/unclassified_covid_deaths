...
GROUPING_VARS <- c("total", "division", "placdth_str")
```
...
sub_df |>
    ...
    kable(
        ...
        caption = "Table 1. Estimates of total, reported, and unrecognized COVID-19 deaths in the United States overall and by place of death from March 2020 through December 2021.",
        align = "lccccl",
        escape = FALSE
    ) |> 
    add_header_above(
